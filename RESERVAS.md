COMANDOS USADOS PARA EL DESARROLLO DE ESTE PROYECTO
 --Comando para instalar angular--
  ...
  /Desktop/COMERCIO ELECTRONICO/Repositorio-Git/Brayan-Rodriguez/typescript <<-- solo aqui cambiea el nombre
...
--------------------------------------------------
 ...
 NOTA TODOS LOS PROYECTOS DE ANGULAR QUE CREE SERAN GUARDADOS DENTRO DE LA
 CARPETA TYPESCRIPT
 -------------------------------------------------------------
 https://getbootstrap.com/
---------------------------------------------------------------
comando
ng g m usuario(nombre del modulo a crear) --routing   para crear modulos
--------------------------------------------------------------
comando para crear carpetas dentro del app
ng g c ----nombre de la carpeta
...
** COMANDO PARA INJSTALACION DE LA BASE DE DATOS*****
  se utiliza en cada proyecto que creamos.
